...
project = "rubinlsststablestarsinddf"
copyright = "2025, Sylvie Dagoret-Campagne and Martin Rodriguez Monroy"
author = "Sylvie Dagoret-Campagne and Martin Rodriguez Monroy"
release = version("rubinlsststablestarsinddf")
